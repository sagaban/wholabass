// Map a Songsterr `[numerator, denominator]` duration to the closest
// alphaTab `Duration` + dot count.
//
// Vendored verbatim (only the import header changed) from
//   https://github.com/Metaphysics0/songsterr-downloader
//   src/lib/server/services/converter/duration-mapper.ts
//   (MIT, © 2026 Ryan Roberts).
