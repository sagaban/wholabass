...
export const tomato = defineSemanticTokens.colors({
  ...
  "10": { value: { _light: "#dd4425", _dark: "#ec5e41" } },
  "11": { value: { _light: "#c33113", _dark: "#ff977d" } },
  "12": { value: { _light: "#5c271f", _dark: "#fbd3cb" } },
  a1: { value: { _light: "#ff000003", _dark: "#f1121208" } },
  a2: { value: { _light: "#ff200008", _dark: "#f6312012" } },
  a3: { value: { _light: "#f52c0018", _dark: "#ff312332" } },
  a4: { value: { _light: "#ff35002c", _dark: "#ff200049" } },
  a5: { value: { _light: "#ff2d003d", _dark: "#ff34225a" } },
  a6: { value: { _light: "#f92a0050", _dark: "#ff45356b" } },
  a7: { value: { _light: "#df280067", _dark: "#ff553f7e" } },
  a8: { value: { _light: "#d0250084", _dark: "#ff5b41a8" } },
  a9: { value: { _light: "#db1e00d1", _dark: "#fe5431e2" } },
  a10: { value: { _light: "#d21d00da", _dark: "#ff6644eb" } },
  a11: { value: { _light: "#c0210bec", _dark: "#ff977d" } },
  a12: { value: { _light: "#460900e0", _dark: "#ffd3cbfb" } },
  solid: {
    bg: {
